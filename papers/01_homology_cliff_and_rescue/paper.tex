...
All 20 evaluable distant false alarms (of 41 distant false alarms total; 21 lacked sufficient Pfam annotation in either query or voters) are cross-family. By Wilson 95\% confidence interval, the within-family rate is at most 17\%. The cliff failures observed here are not consistent with missing within-family homologs as the primary mechanism, and panel expansion with additional members of the failing families is therefore unlikely to rescue the cliff in this regime. Stronger conclusions await the 10-seed extension (deferred to v1.2+; see Limitations). The finding is enough to disfavor a large class of naive rescue strategies and to motivate embedding-space surgery (next section) as the better-supported mechanism-level intervention.
