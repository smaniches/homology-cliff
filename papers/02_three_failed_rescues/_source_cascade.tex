...
The same 180-cell factorial shows the learned-metric baseline (50-iteration panel-only Adam triplet-surrogate linear projection to dim$=\min(128, D)$, seed 0) wins pooled $F_1$ in 16 of 18 groups (12 of 12 at t12 and t30; the two misses are at the smallest t6/8M scale at $k=5$). At t30 $R{=}1000$ $k{=}25$, learned pooled $F_1 = 0.891$ (learned 0.8905 vs cosine 0.8476, 10 of 10 seeds), the best value observed anywhere in the factorial. Per-stratum at that cell: $(0.901, 0.525, 0.177)$ for (close, moderate, distant). The learned metric dominates cosine at the deployment-relevant t12 and t30 scales. This is the deployable cliff rescue; it is reported in a companion paper.
