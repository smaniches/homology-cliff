...
python scripts/ci/verify_manifest.py      # 9,464 manifest entries
...
Expected with LFS pulled: 4 passed, 0 failed. Without LFS: 1 passed,
3 skipped (data-dependent tests skip cleanly when .npz files are LFS
pointer stubs).
